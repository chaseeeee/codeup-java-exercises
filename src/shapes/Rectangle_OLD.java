...
public class Rectangle_OLD {   // Defining the Rectangle class.

  private double length;  // Defined variables to use in the class.
  private double width;

  public Rectangle_OLD(double length, double width){   // This is the rectangle constructor accepting 2 variables.
    this.length = length;
    this.width = width;
  }

  public double getArea() {     // This is the method that calculates the getArea for the Rectangle class.
    return length * width;

  }
  public double getPerimeter() {      // This is the method that calculates the getPerimeter for the Rectangle class.
